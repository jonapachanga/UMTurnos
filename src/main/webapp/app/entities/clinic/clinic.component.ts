...
export class ClinicComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.clinicService
            ...
            .subscribe(
                (res: HttpResponse<IClinic[]>) => this.paginateClinics(res.body, res.headers),
    ...
    trackId(index: number, item: IClinic) {
        return item.id;
    }
    ...
    private paginateClinics(data: IClinic[], headers: HttpHeaders) {
