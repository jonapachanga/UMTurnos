...
export class ClinicHistoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.clinicHistoryService
            ...
            .subscribe(
                (res: HttpResponse<IClinicHistory[]>) => this.paginateClinicHistories(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInClinicHistories();
    }
    ...
    trackId(index: number, item: IClinicHistory) {
        return item.id;
    }

    registerChangeInClinicHistories() {
        this.eventSubscriber = this.eventManager.subscribe('clinicHistoryListModification', response => this.loadAll());
    }
    ...
    private paginateClinicHistories(data: IClinicHistory[], headers: HttpHeaders) {
