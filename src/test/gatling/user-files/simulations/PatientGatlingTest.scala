...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "surName":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "mobile":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "insuranceMutual":"SAMPLE_TEXT", "dni":"SAMPLE_TEXT", "numberAfiliated":"SAMPLE_TEXT", "note":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
