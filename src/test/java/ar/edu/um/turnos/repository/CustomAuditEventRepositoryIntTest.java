...
import ar.edu.um.turnos.config.audit.AuditEventConverter;
import ar.edu.um.turnos.domain.PersistentAuditEvent;
...
import static ar.edu.um.turnos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
