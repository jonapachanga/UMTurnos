    ...
    describe('Turn Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/turns';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Turn', () => {
                service.create(new Turn(null)).subscribe(received => {
            ...
            it('should update a Turn', () => {
                service.update(new Turn(123)).subscribe(received => {
