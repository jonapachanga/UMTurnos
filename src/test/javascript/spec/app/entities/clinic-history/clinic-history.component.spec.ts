...
import { ClinicHistoryComponent } from 'app/entities/clinic-history/clinic-history.component';
...
describe('Component Tests', () => {
    describe('ClinicHistory Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.clinicHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
