...
describe('Service Tests', () => {
    describe('ClinicHistory Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClinicHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/clinic-histories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ClinicHistory', () => {
                service.create(new ClinicHistory(null)).subscribe(received => {
            ...
            it('should update a ClinicHistory', () => {
                service.update(new ClinicHistory(123)).subscribe(received => {
            ...
            it('should return a ClinicHistory', () => {
            ...
            it('should return a list of ClinicHistory', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ClinicHistory(123)]);
            });
