    ...
    describe('Clinic Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/clinics';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Clinic', () => {
                service.create(new Clinic(null)).subscribe(received => {
            ...
            it('should update a Clinic', () => {
                service.update(new Clinic(123)).subscribe(received => {
